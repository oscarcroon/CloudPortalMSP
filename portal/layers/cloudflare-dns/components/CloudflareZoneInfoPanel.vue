<template>
  <section class="mod-cloudflare-dns-info-panel">
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          <h3 class="text-sm font-medium text-slate-900 dark:text-slate-50">
            {{ $t('cloudflareDns.zoneInfo.title') }}
          </h3>
      ...
      <div v-if="expanded" class="mt-4 overflow-hidden">
        <div v-if="soaRecord && parsedSoa" class="space-y-3">
          ...
          <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.primaryNs') }}
              </span>
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.responsibleParty') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.serial') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
                {{ parsedSoa.serial }}
              </span>
          ...
          <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.refresh') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.retry') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.expire') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
            ...
            <div class="flex flex-col gap-0.5">
              <span class="text-xs font-medium text-slate-500 dark:text-slate-400">
                {{ $t('cloudflareDns.zoneInfo.minimumTtl') }}
              </span>
              <span class="font-mono text-sm text-slate-900 dark:text-slate-50">
          ...
          <div v-if="!parsedSoa.isValid || parsedSoa.extra.length > 0" class="mt-2">
            ...
            >
              ...
              {{ $t('cloudflareDns.zoneInfo.details') }}
            </button>
        ...
        <div v-else class="text-sm text-slate-500 dark:text-slate-400">
          {{ $t('cloudflareDns.zoneInfo.notFound') }}
        </div>
      </div>
    </Transition>
  </section>
...
import { parseSoaContent, formatDuration } from '@cloudflare-dns/lib/parse-soa'
