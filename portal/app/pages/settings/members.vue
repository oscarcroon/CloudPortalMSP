            ...
            <tbody class="divide-y divide-slate-100 dark:divide-white/5">
              <tr v-for="member in visibleMembers" :key="member.id">
                ...
                <td class="px-6 py-4">
                  <select
                    :value="member.role"
                    class="members-role-select rounded border border-slate-200 bg-white px-2 py-1 text-sm text-slate-900 dark:border-white/10 dark:bg-slate-800 dark:text-slate-200"
...
<style>
.members-role-select option {
  background-color: rgb(255 255 255);
  color: rgb(15 23 42);
}
.dark .members-role-select option {
