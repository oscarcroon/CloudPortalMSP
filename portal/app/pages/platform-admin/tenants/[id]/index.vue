    ...
    <div v-else-if="tenant" class="space-y-6">
      ...
      <div class="flex flex-wrap gap-2">
        <NuxtLink
          ...
          :to="`/platform-admin/tenants/${tenant.id}/providers/new`"
        ...
        <NuxtLink
          ...
          :to="`/platform-admin/organizations/new?tenantId=${tenant.id}`"
        ...
        <NuxtLink
          ...
          :to="`/platform-admin/tenants/${tenant.id}/members`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
        ...
        <NuxtLink
          v-if="tenant.type === 'provider' || tenant.type === 'distributor'"
          :to="`/platform-admin/tenants/${tenant.id}/email`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
        ...
        <NuxtLink
          v-if="tenant.type === 'provider' || tenant.type === 'distributor'"
          :to="`/platform-admin/tenants/${tenant.id}/modules`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
        ...
        <NuxtLink
          ...
          :to="`/platform-admin/tenants/${tenant.id}/msp-roles`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
        ...
        <NuxtLink
          ...
          :to="`/platform-admin/distributors/${tenant.id}/msp-role-templates`"
        ...
        <NuxtLink
          v-if="tenant.type === 'provider' || tenant.type === 'distributor'"
          :to="`/platform-admin/tenants/${tenant.id}/branding`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
        ...
        <NuxtLink
          ...
          :to="`/platform-admin/tenants/${tenant.id}/audit-logs`"
          class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10"
        >
...
watch(() => tenant.value, (t) => {
  if (t?.id && t?.name) {
    entityNames.setName('tenant', t.id, t.name)
  }
}, { immediate: true })
...
const submitDelete = async () => {
  ...
  try {
    ...
    closeDeleteModal()
    router.replace({ path: '/platform-admin/tenants', query: { deleted: tenant.value.slug } })
  } catch (err: any) {
