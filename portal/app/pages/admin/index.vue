        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-card dark:border-white/10 dark:bg-slate-900/70">
          ...
          <div v-if="currentTenant" class="space-y-4">
            ...
            <div class="flex items-start justify-between">
              <div class="flex items-center gap-4">
                <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-brand/10 text-brand">
                  <Icon icon="mdi:office-building-outline" class="h-6 w-6" />
                </div>
                <div>
              ...
              <NuxtLink
                :to="`/admin/tenants/${currentTenant.id}`"
            ...
            <div class="grid gap-4 sm:grid-cols-3">
              ...
              <NuxtLink
                :to="`/admin/tenants/${currentTenant.id}/members`"
                class="rounded-lg border border-slate-100 bg-slate-50 p-4 transition hover:border-brand/30 hover:bg-brand/5 dark:border-white/5 dark:bg-white/5 dark:hover:border-brand/30 dark:hover:bg-brand/10"
              >
              ...
              <NuxtLink
                :to="`/admin/tenants/${currentTenant.id}/modules`"
                class="rounded-lg border border-slate-100 bg-slate-50 p-4 transition hover:border-brand/30 hover:bg-brand/5 dark:border-white/5 dark:bg-white/5 dark:hover:border-brand/30 dark:hover:bg-brand/10"
              >
                <p class="text-2xl font-bold text-slate-900 dark:text-slate-100">—</p>
...
const tenantActions = computed(() => {
  ...
  if (isProvider) {
    actions.push({
      to: `/admin/organizations/new?tenantId=${tenantId}`,
      icon: 'mdi:home-plus',
  ...
  // Members
  actions.push({
    to: `/admin/tenants/${tenantId}/members`,
  ...
  // Email settings
  actions.push({
    to: `/admin/tenants/${tenantId}/email`,
  ...
  // Module permissions
  actions.push({
    to: `/admin/tenants/${tenantId}/modules`,
  ...
  if (isDistributor) {
    actions.push({
      to: `/admin/distributors/${tenantId}/msp-role-templates`,
  ...
  // Branding
  actions.push({
    to: `/admin/tenants/${tenantId}/branding`,
