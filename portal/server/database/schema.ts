...
// Import layer schemas (auto-generated by scripts/generate-layer-schemas.ts)
import { createAllLayerSchemas } from './layer-schemas.generated'
...
/**
 * Layer plugin tables — auto-generated imports from layers with database schemas.
 * See scripts/generate-layer-schemas.ts and layer-schemas.generated.ts.
 */
const layerSchemas = createAllLayerSchemas(organizations.id)

// Cloudflare DNS (prefixed with cloudflare_dns_)
export const cloudflareDnsOrgConfig = layerSchemas.cloudflareDnsOrgConfig
export const cloudflareDnsZonesCache = layerSchemas.cloudflareDnsZonesCache
export const cloudflareDnsZoneAcls = layerSchemas.cloudflareDnsZoneAcls

// Windows DNS (prefixed with windows_dns_)
export const windowsDnsZones = layerSchemas.windowsDnsZones
export const windowsDnsZoneMemberships = layerSchemas.windowsDnsZoneMemberships
export const windowsDnsOrgConfig = layerSchemas.windowsDnsOrgConfig
export const windowsDnsAllowedZones = layerSchemas.windowsDnsAllowedZones
export const windowsDnsLastDiscovery = layerSchemas.windowsDnsLastDiscovery
export const windowsDnsBlockedZones = layerSchemas.windowsDnsBlockedZones

// Windows DNS Redirects (prefixed with windows_dns_redirect_)
export const windowsDnsRedirects = layerSchemas.windowsDnsRedirects
export const windowsDnsRedirectHits = layerSchemas.windowsDnsRedirectHits
export const windowsDnsRedirectOrgConfig = layerSchemas.windowsDnsRedirectOrgConfig
export const windowsDnsRedirectImportLogs = layerSchemas.windowsDnsRedirectImportLogs
export const windowsDnsManagedRecords = layerSchemas.windowsDnsManagedRecords

// Certificates (prefixed with cert_)
export const certAgents = layerSchemas.certAgents
export const certCredentialSets = layerSchemas.certCredentialSets
export const certOrders = layerSchemas.certOrders
export const certOrderRuns = layerSchemas.certOrderRuns
export const certCertificates = layerSchemas.certCertificates
