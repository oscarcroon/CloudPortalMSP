...
/**
 * WindowsDnsRedirect Toast Container Component
 * Displays toast notifications in the top-right corner
 */
const { toasts, removeToast } = useWindowsDnsRedirectToast()
  ...
  <Teleport to="body">
    <div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 max-w-sm">
      <TransitionGroup name="toast">
        ...
        >
          <!-- Icon -->
          <div :class="iconStyles[toast.type]" v-html="icons[toast.type]"></div>
