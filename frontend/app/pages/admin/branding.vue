              ...
              <div>
                ...
                <div class="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  <button
                    ...
                    :class="[
                      globalTheme?.paletteKey === option.key
...
const globalHasCustomAccent = computed(() =>
  Boolean(globalTheme.value?.accentColor || globalTheme.value?.paletteKey)
)
...
async function fetchBranding() {
  ...
  try {
    ...
    accentForm.paletteKey = globalTheme.value?.paletteKey ?? ''
